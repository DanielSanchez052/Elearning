...
namespace ELearning.Infrastructure.Migrations
{
    ...
    [Migration("20260305025141_FixCountryRelationships")]
    partial class FixCountryRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ELearning.Domain.Entities.UserLessonProgress", b =>
                {
                    ...
                    b.ToTable("user_lesson_progress", null, t =>
                        {
                            t.HasCheckConstraint("chk_ulp_score", "quiz_score IS NULL OR (quiz_score BETWEEN 0 AND 100)");
                        });
                });
            ...
            modelBuilder.Entity("ELearning.Domain.Entities.QuizQuestion", b =>
                {
                    b.HasOne("ELearning.Domain.Entities.Lesson", "Lesson")
                        ...
                        .HasForeignKey("ELearning.Domain.Entities.QuizQuestion", "LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
